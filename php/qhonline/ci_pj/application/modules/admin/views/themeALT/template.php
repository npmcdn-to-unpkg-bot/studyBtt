                                    ...
                                    <div class="direct-chat-messages">
                                        ...
                                        <div class="direct-chat-msg">
                                            ...
                                            <img class="direct-chat-img"
                                                 src="<?php echo base_url() ?>/public/dist/img/user1-128x128.jpg"
                                        ...
                                        <div class="direct-chat-msg right">
                                            ...
                                            <!-- /.direct-chat-info -->
                                            <img class="direct-chat-img"
                                                 src="<?php echo base_url() ?>/public/dist/img/user3-128x128.jpg"
                                                 alt="message user image"><!-- /.direct-chat-img -->
                                            <div class="direct-chat-text">
                                ...
                                <span class="contacts-list-name">
                                  ...
                                  <small class="contacts-list-date pull-right">2/28/2015</small>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                         src="<?php echo base_url() ?>/public/dist/img/user7-128x128.jpg"
                                                         alt="User Image">
                                ...
                                <span class="contacts-list-name">
                                  ...
                                  <small class="contacts-list-date pull-right">2/20/2015</small>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                         src="<?php echo base_url() ?>/public/dist/img/user5-128x128.jpg"
                                                         alt="User Image">
                                ...
                                <span class="contacts-list-name">
                                  ...
                                  <small class="contacts-list-date pull-right">2/10/2015</small>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                         src="<?php echo base_url() ?>/public/dist/img/user6-128x128.jpg"
                                                         alt="User Image">
                                ...
                                <span class="contacts-list-name">
                                  ...
                                  <small class="contacts-list-date pull-right">1/27/2015</small>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                         src="<?php echo base_url() ?>/public/dist/img/user8-128x128.jpg"
                                                         alt="User Image">
                            ...
                            <div class="box box-danger">
                                ...
                                <div class="box-body no-padding">
                                    <ul class="users-list clearfix">
                                        <li>
                                            <img src="<?php echo base_url() ?>/public/dist/img/user1-128x128.jpg"
                                                 alt="User Image">
                                            <a class="users-list-name" href="#">Alexander Pierce</a>
                                            <span class="users-list-date">Today</span>
                                        </li>
                                        <li>
                                            <img src="<?php echo base_url() ?>/public/dist/img/user8-128x128.jpg"
                                                 alt="User Image">
                                            <a class="users-list-name" href="#">Norman</a>
                                            <span class="users-list-date">Yesterday</span>
                                        </li>
                                        <li>
                                            <img src="<?php echo base_url() ?>/public/dist/img/user7-128x128.jpg"
                                                 alt="User Image">
                                            <a class="users-list-name" href="#">Jane</a>
                                            <span class="users-list-date">12 Jan</span>
                                        </li>
                                        <li>
                                            <img src="<?php echo base_url() ?>/public/dist/img/user6-128x128.jpg"
                                                 alt="User Image">
                                            <a class="users-list-name" href="#">John</a>
                                            <span class="users-list-date">12 Jan</span>
                                        </li>
                                        <li>
                                            <img src="<?php echo base_url() ?>/public/dist/img/user2-160x160.jpg"
                                                 alt="User Image">
                                            <a class="users-list-name" href="#">Alexander</a>
                                            <span class="users-list-date">13 Jan</span>
                                        </li>
                                        <li>
                                            <img src="<?php echo base_url() ?>/public/dist/img/user5-128x128.jpg"
                                                 alt="User Image">
                                            <a class="users-list-name" href="#">Sarah</a>
                                            <span class="users-list-date">14 Jan</span>
                                        </li>
                                        <li>
                                            <img src="<?php echo base_url() ?>/public/dist/img/user4-128x128.jpg"
                                                 alt="User Image">
                                            <a class="users-list-name" href="#">Nora</a>
                                            <span class="users-list-date">15 Jan</span>
                                        </li>
                                        <li>
                                            <img src="<?php echo base_url() ?>/public/dist/img/user3-128x128.jpg"
                                                 alt="User Image">
                            ...
                            <ul class="products-list product-list-in-box">
                                <li class="item">
                                    <div class="product-img">
                                        <img src="<?php echo base_url() ?>/public/dist/img/default-50x50.gif"
                                             alt="Product Image">
                                    </div>
